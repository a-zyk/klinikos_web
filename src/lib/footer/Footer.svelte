<script>
  ...
  import InstagramIcon from "../assets/InstagramIcon.svelte";
  import LayoutOuterContainer from "../layout/LayoutOuterContainer.svelte";
  import FooterItemWrapper from "./FooterItemWrapper.svelte";
</script>


<div class="w-full flex flex-col font-poppins bg-bg_light pt-14">
    <LayoutOuterContainer>
    <div
      class="flex flex-col gap-8 items-center md:items-start md:justify-between md:flex-row self-center"
    >
      ...
      <FooterItemWrapper>
        <div class="font-bold">Adresas</div>
        <div>Senasis Ukmergės k. 39A</div>
        <div>Užubaliai, Vilniaus r.</div>
      </FooterItemWrapper>
    </div>
    <div class="flex flex-col items-center justify-center mt-8">
      <div class="flex gap-5"><FacebookIcon /> <InstagramIcon /></div>
